<div id="side-panel" class="side-panel" >
		<div class="side-panel-inner">
			...
			<h4 class="title text-center"><i class="fas fa-signal mr-2"></i>Activities</h4>
			<div class="items-wrapper">
				...
				<div class="item">
					<div class="symbol-holder">
						<img class="user-profile" src="{{ asset('admin/assets/images/profiles/profile-20.png') }}" alt="" />
					</div>
					<div class="content-holder">
						<div class="subject-line">
				...
				<div class="item">
					<div class="symbol-holder">
						<img class="user-profile" src="{{ asset('admin/assets/images/profiles/profile-15.png') }}" alt="" />
					</div>
					<div class="content-holder">
						<div class="subject-line">
